      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <img 
              src="https://res.cloudinary.com/dmdxbaecc/image/upload/q_auto/f_auto/v1776927902/image-removebg-preview_yerrff.png" 
              alt="Logo" 
            ...
            <div className="flex items-center space-x-1">
              {navItems.map((item) => (
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-accent text-[#004b4f]"
                >
                  {item.name}
                </button>
              ))}
